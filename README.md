...
|Chart|Description|
|-|-|
|!\[](charts/01\_salary\_comparison.png)|Salary ranges by scenario and seniority|
|!\[](charts/02\_cost\_breakdown.png)|Cost of living breakdown by city|
|!\[](charts/05\_salary\_progression.png)|Salary growth curve Junior → Senior|
|!\[](charts/04\_purchasing\_power\_ratio.png)|Purchasing power ratio (Semi Senior)|
|!\[](charts/03\_net\_savings.png)|Net monthly savings by city \& scenario|
|!\[](charts/06\_linkedin\_hero.png)|Salary vs cost side-by-side (LinkedIn format)|
