...
![Data](https://img.shields.io/badge/Data-Synthetic_(calibrated)-fbbf24)
...
| 🗽 **NYC surprise** | A Semi Senior in NYC saves **$3,120/mo** — less than a Remote worker from Buenos Aires ($2,290/mo) after adjusting for health costs |
...
| Chart | Description |
|---|---|
| ![](charts/01_salary_comparison.png) | Salary ranges by scenario and seniority |
| ![](charts/02_cost_breakdown.png) | Cost of living breakdown by city |
| ![](charts/05_salary_progression.png) | Salary growth curve Junior → Senior |
| ![](charts/04_purchasing_power_ratio.png) | Purchasing power ratio (Semi Senior) |
| ![](charts/03_net_savings.png) | Net monthly savings by city & scenario |
| ![](charts/06_linkedin_hero.png) | Salary vs cost side-by-side (LinkedIn format) |
...
An interactive React dashboard is included in `dashboard/salary-vs-cost-of-living.jsx`. It features:
- Toggle between Junior / Semi Senior / Senior
- Dynamic KPIs, insights, and all 6 chart types
